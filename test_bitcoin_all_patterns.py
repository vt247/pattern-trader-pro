"""
Bitcoin Complete Pattern Analysis
Tests all 8 patterns (ICI + FOUS) on Bitcoin with maximum historical data
"""
...
def load_bitcoin_data(interval='1d', period='2y'):
    """Load Bitcoin data from yfinance"""
    print(f"\nLoading Bitcoin data: {interval} timeframe, {period} period...")
...
def test_ici_patterns_bitcoin():
    """Test all ICI-based patterns on Bitcoin"""
    print("\n" + "="*80)
    print("TESTING ICI PATTERNS ON BITCOIN")
    print("="*80)

    timeframes = [
        ('1d', '2y'),
        ('4h', 'max'),  # ~730 days max for 4h
    ...
    for interval, period in timeframes:
        ...
        df = load_bitcoin_data(interval, period)
...
def test_fous_patterns_bitcoin():
    """Test all FOUS patterns on Bitcoin"""
    print("\n" + "="*80)
    print("TESTING FOUS PATTERNS ON BITCOIN")
    print("="*80)
    ...
    for interval, period in timeframes:
        ...
        print(f"Gold: {len(gold_setups)} total, {len(valid_gold)} valid")
...
if __name__ == "__main__":
    print("="*80)
    print("BITCOIN COMPLETE PATTERN ANALYSIS")
    print("Testing all 8 patterns: ICI, Momentum, W/M, Harmonic, Force, Survival, Revival, Gold")
    print("="*80)

    # Test ICI patterns
    ici_results = test_ici_patterns_bitcoin()

    # Test FOUS patterns
    fous_results = test_fous_patterns_bitcoin()
